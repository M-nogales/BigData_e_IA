...
bc.alterar_mensajes()
integridad, indice = bc.es_valida()

if not integridad:
    print(f"Se detectó alteración en el bloque {indice}, reparando...")
    # bc.reparar_cadena(indice)

bc.mostrar_transacciones()
bc.guardar_en_json("phone_blockchain.json")
bc.guardar_en_txt("phone_blockchain.txt")
